...
def update():
    ...
    os.system("cd .. && cd SMS_Bomber && python DIPTO-BOM.py")
...
def logo():
    ...
    print("\033[94m│ \033[95mAuthor : D1PTO FUCKER                     \033[94m│".center(columns+15))
    print("│ \033[95mTool   : Unlimited SMS Bomber          \033[94m│".center(columns+9))
    print("│ \033[95mGitHub : https://github.com/D1PTO-Official \033[94m│".center(columns+9))
    print("│ \033[95mCoder  : Fuck             \033[37mV3.0 \033[94m│".center(columns+15))
    print("\033[94m└────────────────────────────────────────┘".center(columns+5))
